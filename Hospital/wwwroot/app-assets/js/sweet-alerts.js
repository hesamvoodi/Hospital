...
$(document).ready(function () {
    ...
    $('.type-success').on('click', function () {
        swal("تایید شد!", "تغییرات ذخیره شد!", "success");
    });
    ...
    $('.prompt-function').on('click', function () {
        swal({
            ...
            swal("تایید شد", "تغییرات اجاد شده :" + inputValue, "عملیات موفق");
        });
    ...
    $('.confirm-text').on('click', function () {
        swal({
            ...
            text: " برای تایید روی ذخیره بزنید ",
            type: 'warning',
            showCancelButton: true,
    ...
    $('.confirm-deletee').on('click', function () {
        swal({
            title: 'آیا مطمعن هستید؟',
            text: " برای تایید روی حذف بزنید ",
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#0CC27E',
            cancelButtonColor: '#FF586B',
...
function Deletee(url) {
    ...
    swal({
        title: "آیا حذف این آیتم مطمعن هستید؟",
        text: "آیتم حذف شده قابل بازگشت نمی‌باشد!",
        type: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#0CC27E',
        cancelButtonColor: '#FF586B',
